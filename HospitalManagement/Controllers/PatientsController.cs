    ...
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Patients != null ? 
                          ...
                          Problem("Entity set 'HospitalContext.Patients'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("PatientId,Name,PhoneNumber")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PatientId,Name,PhoneNumber")] Patient patient)
        {
