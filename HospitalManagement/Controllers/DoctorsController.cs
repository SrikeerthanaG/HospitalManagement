...
namespace HospitalManagement.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        {
            var hospitalContext = _context.Doctors.Include(d => d.Hospital);
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,Name,Specialty,HospitalId")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorId,Name,Specialty,HospitalId")] Doctor doctor)
        {
